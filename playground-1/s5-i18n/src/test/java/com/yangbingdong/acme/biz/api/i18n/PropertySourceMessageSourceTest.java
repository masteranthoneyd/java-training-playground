...
public class PropertySourceMessageSourceTest {
    ...
    public void init() throws Exception {
        ...
        propertySourceMessageSource.afterSingletonsInstantiated();
    }
    ...
    public void test() {
        ...
        assertEquals("张三", propertySourceMessageSource.getMessage(code,args, Locale.getDefault()));
        assertEquals("zhangsan", propertySourceMessageSource.getMessage(code,args, Locale.ENGLISH));
        assertEquals("zhang san", propertySourceMessageSource.getMessage(code,args, Locale.US));
